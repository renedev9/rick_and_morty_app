...
class ListCharacterModel {
    ...
    factory ListCharacterModel.fromRawJson(String str) => ListCharacterModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ListCharacterModel.fromJson(Map<String, dynamic> json) => ListCharacterModel(
